...
async function loadStationSheet(station) {
  try {
    ...
    const response = await fetch(`https://wxbackend-production.up.railway.app/api/sheets/form626?station=${station}`);
    ...
    showAlert(`Loaded ${station}'s FORM626 successfully`, 'success');

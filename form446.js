...
async function loadStationSheet(station) {
  try {
    ...
    const response = await fetch(`https://wxbackend-production.up.railway.app/api/sheets/form446?station=${station}`);
    ...
    showAlert(`Loaded ${station}'s FORM446 successfully`, 'success');
